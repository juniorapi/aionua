...
(function () {
    ...
    const ACHIEVEMENTS = {
        ...
        // Blood Mark: у рос. клієнті «Узи кровавої битви», але за правилом
        // проєкту назви беруться з англійського оригіналу — «Знак крові».
        'УЗЫ': 'ЗНАКИ КРОВІ',
    ...
    const ACHIEVEMENT_DESCRIPTIONS = {
        ...
        'Соберите 2100 уз. С 01.08 до 01.09 откат заданий на узы происходит два раза в неделю: среда/воскресенье':
            'Зберіть 2100 знаків крові. З 01.08 до 01.09 відкат завдань на знаки крові відбувається двічі на тиждень: середа/неділя',
